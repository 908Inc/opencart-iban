<?php
// Text
$_['text_title'] = 'IBAN рахунок (Opendatabot)';
...
$_['error_config'] = 'Метод оплати не налаштований (не вказано IBAN, код, API ключ або назву клієнта).';
$_['error_invoice'] = 'Не вдалося створити рахунок. Спробуйте ще раз пізніше.';
$_['error_order'] = 'Замовлення не знайдено.';
$_['error_payment_method'] = 'Будь ласка, оберіть метод оплати IBAN рахунок ще раз.';
